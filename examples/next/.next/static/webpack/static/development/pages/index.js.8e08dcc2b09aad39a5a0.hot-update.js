...
var resolvers = {
  ...
  Query: {
    ...
    getPerson: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(_, _ref2) {
        var id, response;
...
var schemaQuery = makeExecutableSchema({
  typeDefs: [print(typeFilm), print(typePerson), print(typePlanet), print(typeQuery)],
  resolvers: resolvers
});
/**
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return graphql(schemaQuery, "{ getPersons  }");
...
//# sourceMappingURL=index.js.8e08dcc2b09aad39a5a0.hot-update.js.map